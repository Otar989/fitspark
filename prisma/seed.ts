...
const challengeData = [
  ...
  {
    title: "30 Отжиманий",
    short: "Делайте 30 отжиманий ежедневно",
    description: "Делайте 30 отжиманий для укрепления мышц груди, плеч и трицепсов",
    category_slug: "fitness",
    difficulty: "medium",
    target: 30,
    unit: "раз",
    ...
    points: 25,
    tasks: {
      daily: "Выполнить 30 отжиманий",
      tips: ["Начните с коленей, если сложно", "Следите за техникой", "Увеличивайте количество постепенно"]
    }
  },
  {
    title: "Планка 1 Минута",
    short: "Держите планку 1 минуту",
    description: "Держите планку 1 минуту для укрепления мышц кора и улучшения осанки",
    category_slug: "fitness",
    difficulty: "hard",
    target: 60,
    unit: "секунд",
    ...
    premium: true,
    tasks: {
      daily: "Держать планку 60 секунд",
      tips: ["Начните с 15-20 секунд", "Следите за прямой линией тела", "Дышите равномерно"]
    }
  },
  ...
  // Обучение
  {
    ...
    short: "Читайте 20 страниц в день",
    description: "Читайте 20 страниц книги для развития ума и расширения кругозора",
    ...
    points: 20,
    tasks: {
      daily: "Прочитать 20 страниц",
      tips: ["Выберите интересную книгу", "Читайте в одно время", "Ведите заметки"]
    }
  },
  {
    title: "Изучить 10 Новых Слов",
    short: "Изучайте 10 новых слов",
    description: "Изучайте 10 новых слов для развития словарного запаса",
    category_slug: "learning",
    difficulty: "medium",
    target: 10,
    unit: "слов",
    ...
    premium: true,
    tasks: {
      daily: "Изучить 10 новых слов",
      tips: ["Используйте карточки", "Практикуйте в разговоре", "Повторяйте регулярно"]
    }
  },
  ...
  // Продуктивность
  {
    ...
    short: "Наводите порядок на рабочем месте",
    description: "Наводите порядок на рабочем месте для повышения продуктивности",
    ...
    points: 15,
    tasks: {
      daily: "Навести порядок на рабочем месте",
      tips: ["Уберите лишние предметы", "Организуйте документы", "Протрите пыль"]
    }
  }
];
